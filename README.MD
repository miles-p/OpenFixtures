...
**Note that this roadmap is non-linear and some tasks may appear completed before others. This may happen in part due to some things being in beta before being adopted, or because I can't be stuffed to do the next thing. Anything with the ~~strikethrough~~ has been done or at the very least has something done as part of it.**
...
10. Roll OpenFixtures to the newer and better DMXSerial2 library. This supports RDM, and apparently is better at the job. [[link]](https://www.mathertel.de/Arduino/DMXSerial2.aspx)
